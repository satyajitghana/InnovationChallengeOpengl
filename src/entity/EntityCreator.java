...
public class EntityCreator {
	...
	public void createPlayer() {
		...
		player.addComponent(new CollisionComponent(player, player_size/2, player_size/2 , 0, 0));
	...
	public void createBullet() {
		...
		bullet.addComponent(new CollisionComponent(bullet, 8, 8, 0, 0));
	}
	...
	public Entity createWall(float x, float y, float rot, float sx, float sy) {
		...
		wall.addComponent(new CollisionComponent(wall, sx, sy, 0, 0));
