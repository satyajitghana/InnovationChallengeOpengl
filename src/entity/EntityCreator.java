...
public class EntityCreator {
	...
	public void createPlayer() {
		player.addComponent(new TransformComponent(player, new Vector2f(Display.getWidth()/2 - 16, Display.getHeight()/2 - 16), 0));
		player.addComponent(new MaterialComponent(player, new Sprite("/res/images/player.png",32,32)));
